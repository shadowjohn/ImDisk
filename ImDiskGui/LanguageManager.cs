        ...
        {
            {
                "zh-TW", new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
                {
                    ...
                    { "DlgAutoSaveInterval", "自動儲存時間:" },
                    { "AutoSaveManual", "手動 (無定時)" },
                    { "AutoSaveIntervalText", "{0} 分鐘" },
                    { "DlgBrowse", "瀏覽..." },
                    ...
                    { "AboutVersion", "版本" },
                    { "CheckUpdates", "檢查更新" },
                    { "UpdateTitle", "ImDisk GUI 更新" },
                    { "UpdateAvailable", "找到新版 {0}。是否開啟 shadowjohn/ImDisk 發行頁面？" },
                    { "UpdateCurrent", "目前已是最新版。" },
            ...
            },
            {
                "en-US", new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
                {
                    ...
                    { "DlgAutoSaveInterval", "Auto Save:" },
                    { "AutoSaveManual", "Manual" },
                    { "AutoSaveIntervalText", "{0} Min" },
                    { "DlgBrowse", "Browse..." },
                    ...
                    { "UpdateTitle", "ImDisk GUI Updates" },
                    { "UpdateAvailable", "Version {0} is available. Open the shadowjohn/ImDisk release page?" },
